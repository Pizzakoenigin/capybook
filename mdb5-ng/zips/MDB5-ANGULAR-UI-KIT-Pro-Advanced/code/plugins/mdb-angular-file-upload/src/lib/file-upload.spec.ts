...
describe('MDB File Upload', () => {
  ...
  it('should remove white spaces from acceptedExtensions input and emit fileAdded event', () => {
    jest.spyOn(fileUpload.fileAdded, 'emit');
    fileUpload.acceptedExtensions = '.pdf, .docx, .txt, .xlsx';
    fixture.detectChanges();
  ...
  it('should accept .txt file and emit fileAdded event', () => {
    jest.spyOn(fileUpload.fileAdded, 'emit');
    fileUpload.acceptedExtensions = "'.pdf, .docx, .txt, .xlsx'";
    fixture.detectChanges();
  ...
  it('should accept .xlsx file and emit fileAdded event', () => {
    jest.spyOn(fileUpload.fileAdded, 'emit');
    fileUpload.acceptedExtensions = '.pdf, .docx, .txt, .xlsx';
    fixture.detectChanges();
  ...
  it('should accept .docx file and emit fileAdded event', () => {
    jest.spyOn(fileUpload.fileAdded, 'emit');
    fileUpload.acceptedExtensions = '.pdf, .docx, .txt, .xlsx';
    fixture.detectChanges();
  ...
  it('should emit uploadError and display format error', () => {
    jest.spyOn(fileUpload.uploadError, 'emit');
    fileUpload.acceptedExtensions = '.pdf, .docx, .txt, .xlsx';
    fixture.detectChanges();
    ...
    expect(formatError).toBe(
      'Your file has incorrect file format (correct format(s) .pdf  .docx  .txt  .xlsx)'
    );
  });
});
