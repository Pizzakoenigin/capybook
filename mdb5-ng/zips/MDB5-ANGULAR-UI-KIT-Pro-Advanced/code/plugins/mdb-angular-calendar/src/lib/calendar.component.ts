...
export class MdbCalendarComponent implements OnInit {
  ...
  set tooltips(value: boolean) {
    this._tooltips = coerceBooleanProperty(value);
  }
  private _tooltips = true;
  ...
  @Input()
  get viewSelect(): boolean {
    return this._viewSelect;
  }
  set viewSelect(value: boolean) {
    this._viewSelect = coerceBooleanProperty(value);
  }
  private _viewSelect = true;

  @Input()
  get addEventButton(): boolean {
    return this._addEventButton;
  }
  set addEventButton(value: boolean) {
    this._addEventButton = coerceBooleanProperty(value);
  }
  private _addEventButton = true;
  ...
  static ngAcceptInputType_tooltips: BooleanInput;
  static ngAcceptInputType_navigation: BooleanInput;
  static ngAcceptInputType_viewSelect: BooleanInput;
  static ngAcceptInputType_addEventButton: BooleanInput;
}
