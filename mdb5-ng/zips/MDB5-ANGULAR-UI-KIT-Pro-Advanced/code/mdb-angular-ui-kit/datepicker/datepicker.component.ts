...
import { MDB_DATEPICKER_HEADER } from './datepicker-header.directive';
...
export class MdbDatepickerComponent implements OnInit, AfterContentInit, OnDestroy {
  @ContentChild(MDB_DATEPICKER_HEADER, { read: TemplateRef, static: true })
  _headerRef: TemplateRef<any>;
  ...
  @Input()
  get confirmDateOnSelect(): boolean {
    return this._confirmDateOnSelect;
  }
  set confirmDateOnSelect(value: boolean) {
    this._confirmDateOnSelect = coerceBooleanProperty(value);
  }
  private _confirmDateOnSelect = false;
  ...
  @Input()
  get removeCancelBtn(): boolean {
    return this._removeCancelBtn;
  }
  set removeCancelBtn(value: boolean) {
    this._removeCancelBtn = coerceBooleanProperty(value);
  }
  private _removeCancelBtn = false;

  @Input()
  get removeClearBtn(): boolean {
    return this._removeClearBtn;
  }
  set removeClearBtn(value: boolean) {
    this._removeClearBtn = coerceBooleanProperty(value);
  }
  private _removeClearBtn = false;

  @Input()
  get removeOkBtn(): boolean {
    return this._removeOkBtn;
  }
  set removeOkBtn(value: boolean) {
    this._removeOkBtn = coerceBooleanProperty(value);
  }
  private _removeOkBtn = false;
  ...
  get headerRef(): TemplatePortal | null {
    return this._headerPortal;
  }
  private _headerPortal: TemplatePortal | null = null;
  ...
  _selectDate(date: Date): void {
    ...
    if (this.inline || this._confirmDateOnSelect) {
  ...
  private _createHeaderPortal(): void {
    this._headerPortal = new TemplatePortal(this._headerRef, this._vcr);
  }
  ...
  static ngAcceptInputType_confirmDateOnSelect: BooleanInput;
  static ngAcceptInputType_disabled: BooleanInput;
  static ngAcceptInputType_inline: BooleanInput;
  static ngAcceptInputType_openOnInputClick: BooleanInput;
  static ngAcceptInputType_removeCancelBtn: BooleanInput;
  static ngAcceptInputType_removeClearBtn: BooleanInput;
  static ngAcceptInputType_removeOkBtn: BooleanInput;
}
