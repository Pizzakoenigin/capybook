...
import { MDB_STEP_HEADER } from './step-header.directive';
...
export class MdbStepComponent implements OnChanges, AfterContentInit {
  ...
  @ContentChild(MDB_STEP_HEADER, { read: TemplateRef, static: true }) _header: TemplateRef<any>;
  ...
  get header(): TemplatePortal | null {
  ...
  private _createHeaderPortal(): void {
    this._headerPortal = new TemplatePortal(this._header, this._vcr);
  }
